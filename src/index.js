import './index.css'
import './polyfill'
import { init, debug } from '@livechat/chat.io-customer-sdk'
import * as DOMElements from './DOMElements'
import * as DOMOperations from './DOMOperations'

const loader = document.getElementById('chatio-loader')
...
const sdk = debug(init({ license: 8928139, clientId: '594196e3d51399a5a4f978ab87348403' }))
window.sdk = sdk
...
const sendMessage = (chat, id, text) => {
	const message = { customId: id, text }
...
DOMElements.chatIoWindowMinimized.onclick = DOMOperations.toggleMinimized
