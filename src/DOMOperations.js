...
export const toggleMinimized = () => {
	DOMElements.chatIoWindow.classList.toggle('minimized')
	DOMElements.chatIoWindowMinimized.classList.toggle('minimized')
}
...
export const appendChat = chatId => {
	...
	const chatWindow = DOMElements.chatIoWindow
